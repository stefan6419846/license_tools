...
class CheckImageMetadataTestCase(TestCase):
    ...
    def test_croissant_jpg(self) -> None:
        ...
        first_line, result_without_first_line = result.split("\n", maxsplit=1)  # type: ignore[union-attr]
        self.assertRegex(
            expected_regex=r"^\[ExifTool\]      ExifTool Version Number         : \d+.\d+$",
            text=first_line
        )
...
[File]          File Size                       : 184 kB
[File]          File Modification Date/Time     : 2013:10:04 04:55:49+00:00
