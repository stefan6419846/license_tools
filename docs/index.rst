Welcome to license_tools's documentation!
=========================================

Collection of tools for working with Open Source licenses, focusing on Python packages.

GitHub: `license_tools <https://github.com/stefan6419846/license_tools>`_
...
This tool initially started as some convenience wrapper around the `ScanCode toolkit <https://github.com/nexB/scancode-toolkit/>`_ by nexB Inc. to be used as either a standalone CLI or library. In the meantime, I added some functionality which involves further tooling sometimes irrelevant for ScanCode, sometimes not (yet) implemented there.
...
If you want to use the package as a library, have a look at the :func:`license_tools.retrieval.run` method for example to see how everything interacts. In general:
